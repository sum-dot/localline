...
export default function RouteFinder(props) {
    ...
    for (const bus of allBuses) {
        ...
        for (let i = 0; i < stops.length; i++) {
            if (
                normalizeName(stops[i]) ===
                normalizeName(props.from)
            ) {
                fromIndex = i;
            }
    ...
    return (
        <div className="page">
            ...
            <button className="filter-pill active">
                🚌 All Direct ({matchedBuses.length})
            </button>
            ...
            <footer>
                © 2026 Route Finder · 179 stops · 182 routes
            </footer>
        </div>
    );
}